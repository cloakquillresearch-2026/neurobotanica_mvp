-- NeuroBotanica Unified Database Schema for Cloudflare D1
-- Consolidated from mvp_schema.sql and dynamic_schema.sql
-- Production-ready schema with proper constraints, defaults, and indexes

-- Consent artifacts for Traditional Knowledge (TK)
...
-- Audit log for TK governance and HIPAA compliance
...
-- Clinical studies (added from dynamic_schema.sql)
